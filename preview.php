        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h1>Showing preview text</h1>
                    <p>Add a short text to preview the event information. Use the attribute
                        <code>data-preview="preview text"</code> to specify the text you want.</p>
                    <hr />
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="tile">Demostration of preview text and show tooltip on mouse hover</h4>
                    </div>
                    <div class="col-md-6">
